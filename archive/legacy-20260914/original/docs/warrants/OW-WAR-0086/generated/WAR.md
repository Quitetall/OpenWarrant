...
WAR: OW-WAR-0086
Compilation basis: sha256:8322ba193669e5f4bafef113f2203876df3be7c752213f07c2671ced0a49b1cb
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0086/manifest.toml
-->

# OW-WAR-0086: Expose the complete compiler through a machine-safe CLI
...
milestones:
  - id: "M1"
    title: "Integrate capture/master and project/export/check as narrow command stages"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify CLI reports, atomic output and legacy compatibility"
...
- **scope:** war context capture/master/project/export/check over the same typed library request model; P2-COMPILER.
- **evidence:** Exercise the documented command sequence from fresh inputs to a checked offline package. JSON mode emits one report on stdout with diagnostics on stderr; repeated requests reproduce bytes. Existing war compile keeps its legacy behavior.

### OBL-002 — the controls reject their stated counterexamples
- **scope:** the refusal cases within war context capture/master/project/export/check over the same typed library request model.
- **evidence:** Malformed requests, missing context, access denial, budget overflow and write failures exit nonzero without partial publication or hidden prompts. Unknown cost or readiness must not appear as zero or granted permission.
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:c33f5b7cf1c6a5c9…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:20f9102bcc0792d6…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:b5ef058604c6411a…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:2a4690231c0b8c02…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:761c48d62820c248…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:36c62b1619180e12dbeee26ff71adff86fac82e57d1e39e5f472eeeab274cb79`
- **composition revision digest:** `sha256:9a510f836f89922c08a8bed02accf3b0c2ac2f0f09424be4c583732fdf4ef9ae`
- **workspace basis digest:** `sha256:8322ba193669e5f4bafef113f2203876df3be7c752213f07c2671ced0a49b1cb`
