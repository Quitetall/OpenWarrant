...
WAR: OW-WAR-0076
Compilation basis: sha256:fce5efa98aad199613d5bf9a7e47adf18b1cc8a2e217f0815106d72452ac4f50
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0076/manifest.toml
-->

# OW-WAR-0076: Author valid documents from explicit fields
...
T54-T56 prove deterministic field assembly, exact content preservation, parse/validate round trips and an atomic one-field edit or cancellation through the thin I/O driver. No caller maintains digest/index fields by hand.

Duplicate or invalid fields are refused without partial publication. Delimiter, marker and shell-like user text is escaped/preserved or explicitly refused as the contract permits; it cannot inject a field or execute. An interrupted edit leaves prior bytes intact.
...
milestones:
  - id: "M1"
    title: "Deliver field assembly with round-trip fixtures"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Verify malformed fields and deterministic output independently"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:6b50071746b55639…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:8f86182e13be3aa9…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:7c03a6df161b7e57…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:7531ee93b390333c…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:ced96b7f13e4d1ca…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:e6c8d1e4902e94724fdc8b272bf800972a11c0d34c309c2abf43066c24520d35`
- **composition revision digest:** `sha256:708e4a15f134b2b9d481e37b019c77a43660eb6a3c4564fa8f24b670c8235365`
- **workspace basis digest:** `sha256:fce5efa98aad199613d5bf9a7e47adf18b1cc8a2e217f0815106d72452ac4f50`
