...
WAR: OW-WAR-0089
Compilation basis: sha256:fc2697585762c76b30bbcd3305a769c6e9c862a8c9e2b65d824306d8a87cacdb
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0089/manifest.toml
-->

# OW-WAR-0089: Prepare installable compiler release artifacts and user docs
...
- `Cargo.toml`
- `crates/openwarrant-*/Cargo.toml`
- `docs/COMPATIBILITY.md`
- `docs/RC2_AUTHORING.md`
- `docs/RC2_COMPILER.md`
- `CHANGELOG.md`
- `README.md`
...
Candidate packaging includes executable, license, versioned standard/format/schema/fixture manifest and checksums. Fresh Linux/macOS installs execute the documented examples; help and JSON reports agree with the installed build.

Wrong-platform assets, checksum mismatch, missing normative companions and stale installed binaries fail the installation/release checks. Signed README or other pinned deliveries change only through the approved correction/successor path.
...
milestones:
  - id: "M1"
    title: "Package a release candidate and write reproducible consumer instructions"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify Linux/macOS installs and documentation examples"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:6c1b090c87015acf…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:cc3478a66fef4069…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:79052e9b90f33291…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:f9346aae3cbce8d3…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:a9267bb92d32f851…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:96d3d2ecaabfae3da1d2fb5381f7c82063df7b570fc0d9d7b34763aef6a635bc`
- **composition revision digest:** `sha256:c690e5186128b64ab19e84299f9085e423b0e7100265eb293b506be02add1483`
- **workspace basis digest:** `sha256:fc2697585762c76b30bbcd3305a769c6e9c862a8c9e2b65d824306d8a87cacdb`
