...
WAR: OW-WAR-0047
Compilation basis: sha256:f28cb0b98260ed92828fb4a62be53b99480c486d228042a3a556554a29c346f2
Contract revision: 1
...
milestones:
  ...
  - id: "M3"
    ...
    depends_on: ['M1']
    stage_refs: ["STAGE-002", "STAGE-003"]
...
stages:
  ...
  - id: "STAGE-002"
    title: "Materialize a corpus in BLUT"
    executor_kind: "blut"
    responsibility_tier: "T1"
    executor_ref: "materialize_dataset_path"
    context_sections: ["40-work-order.md#Deliverables", "40-work-order.md#Premade Instructions"]
    context_external: ["sas://§47.2", "sas://§33"]
    executor_args: '{"path": "conformance/fixtures/ow-war-0047-corpus.jsonl"}'
    outputs: ["corpus:war/corpus"]

  - id: "STAGE-003"
    title: "Filter that corpus in BLUT"
    executor_kind: "blut"
    responsibility_tier: "T1"
    executor_ref: "filter_dataset"
    executor_args: '{"min_turns": 2, "drop_errors": true}'
...
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:9752ebdb7a992b84…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:9931ad1c45e71970…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:c240b53cfb61a93f…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:a210ab75cce9bf02…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:5533f8c14b4f99ec89b7953f03fc3483252a4d8484186fbb60ca778c8d8c7be6`
- **composition revision digest:** `sha256:c04514ef2de77107f6216d183d886406a2d50399b6727bb261c0b0599ca5b9ab`
- **workspace basis digest:** `sha256:f28cb0b98260ed92828fb4a62be53b99480c486d228042a3a556554a29c346f2`
