...
WAR: OW-WAR-0088
Compilation basis: sha256:ab028f492055558739bcf45147fb183e0546379098691bfe19764c9e7d052ed0
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0088/manifest.toml
-->

# OW-WAR-0088: Make document authoring interactive and recoverable

## Control

| Field | Value |
|---|---|
| UUID | `01a09e54-1eb1-76e3-8544-e482e6f6b8d7` |
| Local alias | `OW-WAR-0088` |
...
milestones:
  - id: "M1"
    title: "Deliver the interactive field-editing loop"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify cancellation, recovery and parity with scripted authoring"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:b66455f9269cdd78…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:d989a8c4c2c2e83d…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:b39146624cb780bc…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:ca6c10e31408a702…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:1336e71bf485d2ee…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:ca0bc895e2132b97c50d873df0fee5e9cc71100045dae8088a3f12f175d87dca`
- **composition revision digest:** `sha256:2c1b79b6b06bd0f878f79d75980fb59f669ae6ef5d48a5a580a3e054478a301d`
- **workspace basis digest:** `sha256:ab028f492055558739bcf45147fb183e0546379098691bfe19764c9e7d052ed0`
