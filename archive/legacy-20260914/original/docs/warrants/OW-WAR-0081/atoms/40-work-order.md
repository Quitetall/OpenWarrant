...
- `crates/openwarrant-compiler/src/package.rs`
- `crates/openwarrant-compiler/examples/rc2_probe.rs`
- `conformance/rc2/packages/`
...
T32-T37 prove offline reading, semantic membership reconstruction and repeatable bytes/root digests in fresh directories.

Deleted or altered blobs, rehashed-but-incomplete membership, invalid ranges, path traversal, symlinks, extra files and access-denied full sources are refused without out-of-root writes or leaked bytes.
