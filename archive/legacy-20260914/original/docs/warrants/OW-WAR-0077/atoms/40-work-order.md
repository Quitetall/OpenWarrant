...
- `crates/openwarrant-compiler/src/source_set.rs`
- `crates/openwarrant-compiler/examples/rc2_probe.rs`
- `conformance/rc2/source-set/`
...
T11-T15 prove exact unit lookup after heading changes, original-byte pins, opaque fixture capture and enumeration-independent lock bytes.

Missing/ambiguous identity, digest mismatch, traversal, absolute paths, symlinks and changed-during-capture sources refuse publication while preserving previous output.
