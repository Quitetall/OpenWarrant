...
- `conformance/rc2/`
- `docs/design/rc2-phase-1-evidence.md`
...
All eleven features and all 56 cases report fixture digests, observed results and matched expectations with no skips; focused tests and cargo xtask gate pass on the pinned toolchain. An independent reviewer reproduces the direct-driver runs.

Deleting a case, returning constant success, dispatching on fixture names or removing required assertions must make the test harness fail. A legacy regression or unavailable required check cannot be recorded as PASS.
