...
WAR: OW-WAR-0080
Compilation basis: sha256:c23085df0369ae7bfeaee50d74fdc77337e4a7573b3e9b3f71bdef3232121734
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0080/manifest.toml
-->

# OW-WAR-0080: Build master context and faithful role projections
...
1. Preparation, performer, verifier and human reviewers receive role-specific views with the same exact governing basis and required constraints.
2. A reviewer can reproduce the named positive and refusal observations at
   assemble_master, project_role and render_entry over one versioned IR.

## Scope

Phase 1: F06, T27, T28, T29, T30, T31.
...
milestones:
  - id: "M1"
    title: "Assemble one master and all four role views with golden outputs"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify rule fidelity and claim provenance"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:14970b2f7e3f6a23…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:f255cf01ee8c42c4…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:fa8622d9c39ef24b…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:7d58b769f10bc1cd…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:44ec92ff854ddd08…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:3eacaf0f241d2107ac899c8a760622b7b3e5f8b702478eef95e67896d9c151af`
- **composition revision digest:** `sha256:a161b7b7e85d24e7db8f94dff5feeae4edcb3e0f45b754076df78f0c28610ca4`
- **workspace basis digest:** `sha256:c23085df0369ae7bfeaee50d74fdc77337e4a7573b3e9b3f71bdef3232121734`
