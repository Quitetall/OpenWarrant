...
WAR: OW-WAR-0090
Compilation basis: sha256:6cd33055031cb498365cad9ba4bff8ba58b2583a03a475f5c6ffa9eb65c92755
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0090/manifest.toml
-->

# OW-WAR-0090: Qualify the integrated compiler and freeze the Stable source set

## Control

| Field | Value |
|---|---|
| UUID | `01a09e54-1eb7-78d3-8eb0-45b5463010df` |
| Local alias | `OW-WAR-0090` |
...
1. The owner receives a complete, independently reviewed Stable acceptance package that binds the actual compiler build, standard edition and observed release evidence.
2. A reviewer can reproduce the named positive and refusal observations at
   Integrated CLI/compiler conformance, deterministic context tasks and exact release-candidate artifacts.

## Scope

Stable qualification: P2-CONFORMANCE, P2-CONTEXT-12.
...
milestones:
  - id: "M1"
    title: "Prepare the Stable edition and run integrated conformance and context evaluation"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify the exact candidate and remaining risks"
    stage_refs: ["STAGE-002"]
    obligation_refs: ["OBL-001", "OBL-002"]
    depends_on: ["M1"]
  - id: "M3"
    title: "Accept the exact Stable standard and compiler result"
...
- **scope:** Integrated CLI/compiler conformance, deterministic context tasks and exact release-candidate artifacts; P2-CONFORMANCE, P2-CONTEXT-12.
- **evidence:** Review and bind the separately materialized Stable standard/schema/fixture edition and approved identifier/compatibility changes. Run all T01-T56 through integrated public paths with the exact Stable build, exact JSON/rendering goldens, resource/write-failure cases, offline Linux/macOS consumers and cargo xtask gate. At least twelve fixed context tasks meet 100% expected required-unit coverage and zero binding-byte changes or invented authority; include at least three no-SHALL dependency tasks, three UNKNOWN tasks and three expected refusals. Independent verification and human acceptance bind the exact Stable candidate.

### OBL-002 — the controls reject their stated counterexamples
- **scope:** the refusal cases within Integrated CLI/compiler conformance, deterministic context tasks and exact release-candidate artifacts.
- **evidence:** Missing cases, false-green expected-refusal handling, changed release bytes after review, unobserved platform checks or incomplete context prevent qualification. Optional paid agent trials are required only for any claimed agent-efficiency improvement, not for deterministic compilation.
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:62228781509b5526…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:224dbc0271b7a035…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:ab82ad644095432f…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:b06813d9f9538ed6…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:79e3bff3a2cfbabb…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:85d38947b3c6e7464172a2ff470737cad79db186a8c6d680f821c7030fa73090`
- **composition revision digest:** `sha256:d52b4420eec6d4c3c74d926236a315e604424f80b96ecdb7882387c8381b988d`
- **workspace basis digest:** `sha256:6cd33055031cb498365cad9ba4bff8ba58b2583a03a475f5c6ffa9eb65c92755`
