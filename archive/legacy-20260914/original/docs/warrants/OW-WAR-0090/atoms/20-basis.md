...
- Test seam: Integrated CLI/compiler conformance, deterministic context tasks and exact release-candidate artifacts.
- Scoped inventory: P2-CONFORMANCE, P2-CONTEXT-12.

## Prerequisites

Required predecessor outputs: OW-WAR-0089.
