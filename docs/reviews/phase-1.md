...
Linux acceptance passed. See [receipt](../warrants/OW-WAR-0085/implementation/linux-observation-v2.json). Native macOS acceptance with matching source inventory remains missing. Repository gate and independent review are separate observations.
