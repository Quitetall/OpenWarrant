...
revision = 2
title = "RC.2 document and packet format contract"
state = "proposed"
...
# RC.2 document and packet format contract

Status: normative companion to [SAS 1.0.0-rc.2](WAR_Software_Architecture_Specification.md).
These are candidate wire contracts to implement and test, not claims about the
installed `war` binary. No model call is part of any operation below.
