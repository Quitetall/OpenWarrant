...
- `conformance/rc2/interactive/`
- `docs/RC2_AUTHORING.md`
...
Pseudo-terminal scenarios exercise field selection, multiline text, validation feedback, correction and atomic save, producing the same semantic document as noninteractive authoring.

Cancel, EOF, interrupt, invalid field input and failed saves preserve prior bytes and leave no false success report. This does not add a tracker TUI or agent REPL.
