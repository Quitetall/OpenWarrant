...
WAR: OW-WAR-0088
Compilation basis: sha256:d89de4cf9057830799fc083980a39c9fcecd697adca3ac2704b302e00ea03d72
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0088/manifest.toml
-->

# OW-WAR-0088: Make SDK document authoring interactive and recoverable
...
The revised product needs make sdk document authoring interactive and recoverable. Legacy command behavior does not
...
Phase 2 ergonomic SDK consumer; P2-INTERACTIVE. Owner: OpenWarrant SDK consumers. Primary phase: 2.
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:ed112a1e6f303e5e…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:08bdc92b55dac7e3…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:57247ab5c215e733…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:5538831139d4fc29…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:2f47fc518e99a52a…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:b944fdaaa45160f5d161c525295a293ca2d18bf4d0422dab89d174efb2bb7dca`
- **composition revision digest:** `sha256:199c666382f083ee128ff2920a1fb90d2ec654292b470f2260223394294118d9`
- **workspace basis digest:** `sha256:d89de4cf9057830799fc083980a39c9fcecd697adca3ac2704b302e00ea03d72`
