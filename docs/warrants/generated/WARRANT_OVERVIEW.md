...
| [OW-WAR-0054](docs/warrants/OW-WAR-0054/manifest.toml) | The Master Record: a person's document is their access, and can be proven equal to it | `draft` | `current` | `valid` | `controlled` | 12M / 5S |
