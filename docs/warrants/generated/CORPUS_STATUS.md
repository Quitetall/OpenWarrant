...
- Revision 1.0.0 is ACCEPTED (§101.2) and normative. A Warrant compiles against the revision its authorization recorded (§14), so a later revision does not move an authorized contract: 57 against 0.1.0-draft.1, 8 against 0.1.0-draft.3, 34 against 1.0.0.
...
| *unassigned — declares no [[roadmap]]* | — | not derivable — a Warrant naming no phase belongs to no Objective | 0 | 32 | 0 | 0 | 0 |
...
|---|---|
| artifact digests verify | 45 |
| required deliverables exist | 45 |
| every required gate has admissible result | 43 |
| no blocker remains | 42 |
| no required unknown remains | 42 |
| every required obligation is dispositioned | 40 |
| independence requirements are met | 40 |
| exact authorized Contract Revision | 30 |
| required judgments exist | 16 |
| residual risks have sufficient authority | 16 |
...
## Warrants (99) — invalid 0 · draft 51 · ready_to_resolve 19 · would_satisfy 0 · resolved **29**
