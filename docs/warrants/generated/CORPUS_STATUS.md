...
- Revision 1.0.0 is ACCEPTED (§101.2) and normative. A Warrant compiles against the revision its authorization recorded (§14), so a later revision does not move an authorized contract: 57 against 0.1.0-draft.1, 8 against 0.1.0-draft.3, 26 against 1.0.0.
...
| *unassigned — declares no [[roadmap]]* | — | not derivable — a Warrant naming no phase belongs to no Objective | 0 | 24 | 0 | 0 | 0 |
...
|---|---|
| artifact digests verify | 37 |
| required deliverables exist | 37 |
| every required gate has admissible result | 35 |
| no blocker remains | 34 |
| no required unknown remains | 34 |
| every required obligation is dispositioned | 32 |
| independence requirements are met | 32 |
| exact authorized Contract Revision | 22 |
...
## Warrants (91) — invalid 0 · draft 43 · ready_to_resolve 19 · would_satisfy 0 · resolved **29**
