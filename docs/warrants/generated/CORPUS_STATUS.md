...
| roadmap://OW-PHASE-1: File-native WAR compiler | — | not derivable — no member carries the `exit` slug | 0 | 16 | 0 | 1 | 0 |
...
## Warrants (55) — invalid 0 · draft 53 · ready_to_resolve 0 · would_satisfy 2 · resolved **0**
