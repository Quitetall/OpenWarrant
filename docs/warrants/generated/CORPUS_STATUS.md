...
- Revision 1.0.0 is ACCEPTED (§101.2) and normative. A Warrant compiles against the revision its authorization recorded (§14), so a later revision does not move an authorized contract: 57 against 0.1.0-draft.1, 8 against 0.1.0-draft.3, 24 against 1.0.0.
...
| *unassigned — declares no [[roadmap]]* | — | not derivable — a Warrant naming no phase belongs to no Objective | 0 | 22 | 0 | 0 | 0 |
...
| required deliverables exist | 35 |
| every required gate has admissible result | 33 |
| no blocker remains | 32 |
| no required unknown remains | 32 |
| every required obligation is dispositioned | 30 |
| independence requirements are met | 30 |
| exact authorized Contract Revision | 20 |
| required judgments exist | 6 |
| residual risks have sufficient authority | 6 |
...
## Warrants (89) — invalid 0 · draft 41 · ready_to_resolve 19 · would_satisfy 0 · resolved **29**
