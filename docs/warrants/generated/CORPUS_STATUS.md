...
- Revision 1.0.0 is ACCEPTED (§101.2) and normative. A Warrant compiles against the revision its authorization recorded (§14), so a later revision does not move an authorized contract: 57 against 0.1.0-draft.1, 8 against 0.1.0-draft.3, 37 against 1.0.0.
...
| *unassigned — declares no [[roadmap]]* | — | not derivable — a Warrant naming no phase belongs to no Objective | 0 | 35 | 0 | 0 | 0 |
...
|---|---|
| artifact digests verify | 48 |
| required deliverables exist | 48 |
| every required gate has admissible result | 46 |
| no blocker remains | 45 |
| no required unknown remains | 45 |
| every required obligation is dispositioned | 43 |
| independence requirements are met | 43 |
| exact authorized Contract Revision | 33 |
| required judgments exist | 19 |
| residual risks have sufficient authority | 19 |
...
## Warrants (102) — invalid 0 · draft 54 · ready_to_resolve 19 · would_satisfy 0 · resolved **29**
