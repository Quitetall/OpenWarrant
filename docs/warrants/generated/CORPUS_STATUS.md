...
- Revision 1.0.0 is ACCEPTED (§101.2) and normative. A Warrant compiles against the revision its authorization recorded (§14), so a later revision does not move an authorized contract: 57 against 0.1.0-draft.1, 8 against 0.1.0-draft.3, 32 against 1.0.0.
...
| *unassigned — declares no [[roadmap]]* | — | not derivable — a Warrant naming no phase belongs to no Objective | 0 | 30 | 0 | 0 | 0 |
...
|---|---|
| artifact digests verify | 43 |
| required deliverables exist | 43 |
| every required gate has admissible result | 41 |
| no blocker remains | 40 |
| no required unknown remains | 40 |
| every required obligation is dispositioned | 38 |
| independence requirements are met | 38 |
| exact authorized Contract Revision | 28 |
| required judgments exist | 14 |
| residual risks have sufficient authority | 14 |
...
## Warrants (97) — invalid 0 · draft 49 · ready_to_resolve 19 · would_satisfy 0 · resolved **29**
