...
- Revision 1.0.0 is ACCEPTED (§101.2) and normative. A Warrant compiles against the revision its authorization recorded (§14), so a later revision does not move an authorized contract: 57 against 0.1.0-draft.1, 8 against 0.1.0-draft.3, 33 against 1.0.0.
...
| *unassigned — declares no [[roadmap]]* | — | not derivable — a Warrant naming no phase belongs to no Objective | 0 | 31 | 0 | 0 | 0 |
...
|---|---|
| artifact digests verify | 44 |
| required deliverables exist | 44 |
| every required gate has admissible result | 42 |
| no blocker remains | 41 |
| no required unknown remains | 41 |
| every required obligation is dispositioned | 39 |
| independence requirements are met | 39 |
| exact authorized Contract Revision | 29 |
| required judgments exist | 15 |
| residual risks have sufficient authority | 15 |
...
## Warrants (98) — invalid 0 · draft 50 · ready_to_resolve 19 · would_satisfy 0 · resolved **29**
