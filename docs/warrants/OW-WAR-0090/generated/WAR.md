...
WAR: OW-WAR-0090
Compilation basis: sha256:c79b2bd1d168e693eec27511a9dc04b0cd410e14ebf72f2098926d5bf304e548
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0090/manifest.toml
-->

# OW-WAR-0090: Qualify four-phase release and freeze Stable source set
...
- Test seam: independent release review of exact standard/SDK/provider/workflow artifacts.
- Scoped inventory: Phase 4 qualification; P2-CONFORMANCE and P2-CONTEXT-12 retained; all four phase exits.
...
This Warrant binds machine-readable scope from `docs/warrants/OW-WAR-0090/scope.toml` (`sha256:3d8e266b5098ad9ac96177e61992b34f2ddea7e3b4eee0c1579cd42e84c1a76f`).
...
[[scope]]
path_glob = "docs/releases/remaining-build-scope.md"
obligation_refs = ["OBL-001", "OBL-004"]

[[scope]]
path_glob = "docs/warrants/OW-WAR-0086/implementation/progress.json"
obligation_refs = ["OBL-001", "OBL-004"]

[[scope]]
path_glob = "docs/warrants/OW-WAR-0090/**"
obligation_refs = ["OBL-001", "OBL-004"]
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:af697146b1cb4546…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:7b4fada4d5adcf84…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:46232d2a2a5c3ece…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:5538831139d4fc29…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:d0dafa5e43732d27…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:cfa1cf6f6d9bd9fa104ecb12288c7d17174220e21a1c699bf2320155283f9f82`
- **composition revision digest:** `sha256:60f0518f0645faa3f4c4bf4ba389855a9ebb1ac0c67fedb251fe86c6e5624cf3`
- **workspace basis digest:** `sha256:c79b2bd1d168e693eec27511a9dc04b0cd410e14ebf72f2098926d5bf304e548`
