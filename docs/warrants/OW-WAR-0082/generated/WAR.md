...
WAR: OW-WAR-0082
Compilation basis: sha256:509c484d154a527744bfab8a8ba04bc6e2f3374258f198ecb2863589725a2fb0
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0082/manifest.toml
-->

# OW-WAR-0082: Enforce context budgets and invalidate stale cache entries
...
- `crates/openwarrant-compiler/src/budget.rs`
- `crates/openwarrant-compiler/src/basis.rs`
- `crates/openwarrant-compiler/examples/rc2_probe.rs`
- `conformance/rc2/budgets/`
...
T38-T41 cover below/at/above budget limits, rendering overhead, relevant basis changes and a previously omitted routing source becoming applicable.

Over-budget required content causes refusal without truncating rules or publishing a packet. Reusing a cache entry after a material basis change must fail validation.
...
milestones:
  - id: "M1"
    title: "Deliver final-entry accounting and basis-key vectors"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify budget boundaries and cache invalidation"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:d21149bfcb862764…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:1d706ec017f9859d…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:d5b5475a4dbc3b1d…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:6fd86ab1cd6837c7…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:039b2bfb9b4ea9fb…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:043c44ef17601107692721f213673633e82bb94ba81c1a6e7d136243cb9f4579`
- **composition revision digest:** `sha256:c56730cad0d4a872a9ce5d6921e26e03f29524672a8a5bd769e6054d667f1e6b`
- **workspace basis digest:** `sha256:509c484d154a527744bfab8a8ba04bc6e2f3374258f198ecb2863589725a2fb0`
