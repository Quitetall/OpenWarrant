...
WAR: OW-WAR-0070
Compilation basis: sha256:9b31d7c3fdc71926cbac76cd3daaefd7cb099e9af38451f524111564d782bf16
Contract revision: 1
...
milestones:
  ...
  - id: "M2"
    title: "An unreserved debt is a visible gap and malformed debt is refused"
    depends_on: ["M1"]
...
stages:
  ...
  - id: "STAGE-002"
    title: "Plant the named refusals and the unreserved-gap case"
    executor_kind: "agent"
    responsibility_tier: "T2"
...
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:b0b40c548767c35a…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:e11bfc0a80988adc…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:ad03da93c613f7aa…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:68d12015832605d69877bfde58e58c74b7a7f86bd987788abc858b5ce657fe9f`
- **composition revision digest:** `sha256:583c340189a51f49c4efb46c0efc9eee887467891e94c4f55996e80f6ecd5f2c`
- **workspace basis digest:** `sha256:9b31d7c3fdc71926cbac76cd3daaefd7cb099e9af38451f524111564d782bf16`
