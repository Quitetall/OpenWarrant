...
- Test seam: import_legacy and successor-history validation over retained legacy fixtures.
- Scoped inventory: F10, T49, T50, T51, T52, T53.

## Prerequisites

Required predecessor outputs: OW-WAR-0077, OW-WAR-0083.
