...
WAR: OW-WAR-0084
Compilation basis: sha256:754483e4f29e8ed6383f22dee91bc40e1741d36e36704fe882a94b7cd094abd1
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0084/manifest.toml
-->

# OW-WAR-0084: Import legacy history without changing what was signed

## Control

| Field | Value |
|---|---|
| UUID | `01a09e54-1ea5-78c2-be44-8a1bef260a77` |
| Local alias | `OW-WAR-0084` |
...
- `crates/openwarrant-compiler/src/legacy_import.rs`
- `crates/openwarrant-compiler/examples/rc2_probe.rs`
- `conformance/rc2/legacy/`
...
## Legacy terminology and result mapping

Preserve atom/file versus unit/span, legacy resolution versus human acceptance
and qualification, and old receipt/Dispatch meanings. Report original legacy
resolution facts separately. Never synthesize a new acceptance or qualification
record solely from resolved state. Derive acceptance eligibility only from
authenticated, matching evidence; evaluate each assurance-baseline requirement
independently and report unknowns. T49/T50 include these refusal cases.
...
T49-T53 prove historical byte/domain preservation, explicit mapping and successor lineage using retained real records in a disposable corpus.

An imported signature cannot attest a new RC.2 payload or retroactively qualify a result; a successor must not rewrite an accepted historical object or invent missing evidence.
...
milestones:
  - id: "M1"
    title: "Import representative legacy records and a successor version"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify original signatures, domains and missing-fact handling"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:42e859770103568e…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:cad769f300d585d2…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:fbc4a0386e1b5e7c…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:2b2ceb3829ebb6d2…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:30389fc47ba5f667…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:3b075809800496d4d188dfc16b7ad25b44a5046ffaa354c9676d913c6765457b`
- **composition revision digest:** `sha256:61c7d19c76565936661a38fdb560494f232e1443f55e43067aed60ff351ce6f4`
- **workspace basis digest:** `sha256:754483e4f29e8ed6383f22dee91bc40e1741d36e36704fe882a94b7cd094abd1`
