...
WAR: OW-WAR-0081
Compilation basis: sha256:31ad950cee12f19b2ffb95ffe3b1adf80ba71fb9e05b958414abcfdd535b94c5
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0081/manifest.toml
-->

# OW-WAR-0081: Export and verify portable offline context packages
...
milestones:
  - id: "M1"
    title: "Build and read one complete offline package"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently verify semantic tampering, path safety and access controls"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:a9692d52e54c467e…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:7457ce89d14a4a8d…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:dc78feb9442469ba…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:4b105a57b968a574…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:80f60c647fe21109…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:49aed2e4f83777b2de36752e59602a519ff04a6c2582507913758a09e50a661c`
- **composition revision digest:** `sha256:01b708f22e6d17f9aac12e1b2abfcac985e8b678df02ee422b089342875a7e32`
- **workspace basis digest:** `sha256:31ad950cee12f19b2ffb95ffe3b1adf80ba71fb9e05b958414abcfdd535b94c5`
