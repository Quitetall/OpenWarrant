...
WAR: OW-WAR-0087
Compilation basis: sha256:85f4d70286d283e4e9841345359e6066ec3d7910173ae33bdd27c1c4b5abde29
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0087/manifest.toml
-->

# OW-WAR-0087: Expose document and record primitives through CLI
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:3d412a5fb0576831…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:c293047067a7e635…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:2e7d7f5fde80e0fa…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:5538831139d4fc29…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:8965432110d694ec…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:42b46111cf99c53b931a04490428f1ff12047209a377f237fc1b197402a28c2c`
- **composition revision digest:** `sha256:57b8e463b014c7424c40660c966abcfab1dd4072d28f61018439bb728dbaf979`
- **workspace basis digest:** `sha256:85f4d70286d283e4e9841345359e6066ec3d7910173ae33bdd27c1c4b5abde29`
