...
WAR: OW-WAR-0089
Compilation basis: sha256:859e25d4288c8e59bf7e15f9209d16dc5bfb1cf7866a883a8cab6d43855fff81
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0089/manifest.toml
-->

# OW-WAR-0089: Prepare standard and SDK release artifacts

## Control

| Field | Value |
|---|---|
| UUID | `01a09e54-1eb4-7c80-abf5-3e3b33328023` |
| Local alias | `OW-WAR-0089` |
...
The revised product needs prepare standard and sdk release artifacts. Legacy command behavior does not
establish this SDK/provider contract.

## Desired Outcome

Package SDK, standard, CLI, adapted skills and their license notices. Document provider/workflow boundaries; verify Linux/macOS install and examples. Require Phase 3 workflow evidence before promotion; packaging rehearsal may proceed earlier.

## Scope

Phase 4 packaging; P2-INSTALL retained historical case. Owner: OpenWarrant release. Primary phase: 4.
...
- Test seam: clean installation and documented consumer walkthrough from candidate artifacts.
- Scoped inventory: Phase 4 packaging; P2-INSTALL retained historical case.
...
This Warrant binds machine-readable scope from `docs/warrants/OW-WAR-0089/scope.toml` (`sha256:c4372f516a948cb4d4e86cd413e2ff552a091bfe399f7180528511695cd30b02`).
...
[[scope]]
path_glob = "docs/warrants/OW-WAR-0089/**"
obligation_refs = ["OBL-001", "OBL-002", "OBL-004"]
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:4abd988104881fee…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:e26aff0fdbd801c3…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:0923d81226b9db1a…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:5538831139d4fc29…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:aa89d9db0a132ac0…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:e265e884799c39b6ade1ea09ffeea18bc0df6bfb9dee8649e40b30bcd7ee77fa`
- **composition revision digest:** `sha256:8c67b122d990eb1d9ab99e083c1ec2bda2bfa5fc5893f61f6c72619946a08056`
- **workspace basis digest:** `sha256:859e25d4288c8e59bf7e15f9209d16dc5bfb1cf7866a883a8cab6d43855fff81`
