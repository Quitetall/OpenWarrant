...
WAR: OW-WAR-0091
Compilation basis: sha256:195af7240a8103914745dabb13bd4d7dd04e457f149f1ccf4d66e7bb56cf1681
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0091/manifest.toml
-->

# OW-WAR-0091: Publish and verify OpenWarrant Stable 1.0

## Control

| Field | Value |
|---|---|
| UUID | `01a09e54-1ebb-73b0-8a50-bd1764beb29f` |
| Local alias | `OW-WAR-0091` |
...
milestones:
  - id: "M1"
    title: "Prepare the final publication request and recheck name availability"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Approve and perform the governed release act"
    stage_refs: ["STAGE-002"]
    obligation_refs: ["OBL-001", "OBL-002"]
    depends_on: ["M1"]
  - id: "M3"
    title: "Independently verify public artifacts and report completion"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:031d188be04efcaf…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:0d9e4e58306d6479…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:6800e24d7b57b71e…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:03f8a98ec42943ca…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:446dacae7e765e85…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:2e42b37b7130bee3d2d2328c70d76f61202e79f6f70a233676943641b4f8eedf`
- **composition revision digest:** `sha256:505faa6349fedd6cd183aba2acae3167ccd2798475a05ae55eea46ca27bb3d0a`
- **workspace basis digest:** `sha256:195af7240a8103914745dabb13bd4d7dd04e457f149f1ccf4d66e7bb56cf1681`
