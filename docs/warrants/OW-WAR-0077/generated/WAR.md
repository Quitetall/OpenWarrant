...
WAR: OW-WAR-0077
Compilation basis: sha256:f433025ed47e9a2d50b4d2e0fb8abd20aa31ce6c4e83fe4bb78bd731c4442292
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0077/manifest.toml
-->

# OW-WAR-0077: Capture immutable sources and resolve exact references

## Control

| Field | Value |
|---|---|
| UUID | `01a09e54-1e8c-7ec1-a56f-990a6ac8f353` |
| Local alias | `OW-WAR-0077` |
...
milestones:
  - id: "M1"
    title: "Capture and resolve one mixed document and evidence source set"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Exercise filesystem attacks and verify immutable results independently"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:8eacec03281f1183…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:05fb4d93a989e822…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:8579a57c3964d59b…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:3c6cf18efca17917…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:9d3eb4a340efe425…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:6f34354cf66dcfebeae0386c46b9310f5cd3c795f0f3f196b497158de43a9b69`
- **composition revision digest:** `sha256:209892c10a7ecb092c6fadb0dd413b6e76d0deb1cc569a82aef1ce8e7410d5a0`
- **workspace basis digest:** `sha256:f433025ed47e9a2d50b4d2e0fb8abd20aa31ce6c4e83fe4bb78bd731c4442292`
