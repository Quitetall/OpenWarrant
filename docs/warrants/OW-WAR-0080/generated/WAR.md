...
WAR: OW-WAR-0080
Compilation basis: sha256:3341a030dde439c3dce17997dc9a05e06fb131ecd2d50346526f36c00e0435a6
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0080/manifest.toml
-->

# OW-WAR-0080: Prove provider master context and task projections

## Control

| Field | Value |
|---|---|
| UUID | `01a09e54-1e96-7523-b7c6-4b3c2a0e913f` |
| Local alias | `OW-WAR-0080` |
...
The revised product needs prove provider master context and task projections. Legacy command behavior does not
...
T27–T31; external compiler Phase 2. Owner: LAMU/provider. Primary phase: 2.
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:d20d0afab606180a…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:ec4d89fa17e43134…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:54aff541b105e907…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:5538831139d4fc29…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:0753ec80a7d8a238…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:942aee5c1d1cdbd7accc57785260936e152232a49deaf513d55cb8c411a0a99d`
- **composition revision digest:** `sha256:9d98402db8d018e1314f9ae061f98cc89214a5fc36d12d80224caa44e7af0d76`
- **workspace basis digest:** `sha256:3341a030dde439c3dce17997dc9a05e06fb131ecd2d50346526f36c00e0435a6`
