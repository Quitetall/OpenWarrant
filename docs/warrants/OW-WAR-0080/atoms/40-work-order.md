...
- `crates/openwarrant-compiler/src/packet.rs`
- `crates/openwarrant-compiler/examples/rc2_probe.rs`
- `conformance/rc2/role-views/`
...
T27-T31 prove common membership/basis across machine and human views, exact rule slices, retained evidence behind excerpts and provenance/trust label inheritance.

A background summary cannot replace a binding rule; a performer claim cannot turn into a verification disposition; an excerpt cannot masquerade as complete evidence.
