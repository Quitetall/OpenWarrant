...
WAR: OW-WAR-0054
Compilation basis: sha256:9918514884af16397a13b5bb68de7d40c2973ca5ff999463b78ab364b75a3e1f
Contract revision: 1
...
stages:
  - id: "STAGE-001"
    title: "The invariant, before anything it would guard"
  ...
  # Human, not service: the first disclosure sends a real person's records to a
  # real recipient. Nothing in STAGE-004 is discharged by a process deciding it
  # went well.
  - id: "STAGE-004"
    title: "Delivery, and the first real disclosure"
    executor_kind: "human"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:fdb51bb3c61642aa…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:d78ae9a38d19a56f…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:5615c8478a2069e7…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:fd2fe918af956a28…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:992e8a47bbe4d6a0…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:664d0c2142ab2ce26af407e70f1ee5d7318ed1c944141b42060a8220bcc9173f`
- **composition revision digest:** `sha256:c05de43873226bf0cf61b3939e815a62344662dac2dfc58f3453739a39d8e5c7`
- **workspace basis digest:** `sha256:9918514884af16397a13b5bb68de7d40c2973ca5ff999463b78ab364b75a3e1f`
