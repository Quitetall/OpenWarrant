...
WAR: OW-WAR-0085
Compilation basis: sha256:0009b97280cfaa4fea4261411d44f0fff7e949ab5549f9567a1171f5d9115683
Contract revision: 1
Source manifest: docs/warrants/OW-WAR-0085/manifest.toml
-->

# OW-WAR-0085: Prove every Phase 1 primitive through a runnable driver
...
milestones:
  - id: "M1"
    title: "Run the complete library acceptance inventory and repair in scope"
    stage_refs: ["STAGE-001"]
    obligation_refs: ["OBL-001", "OBL-002"]
  - id: "M2"
    title: "Independently reproduce the Phase 1 exit evidence"
...
|---:|---|---|---|---|
| 10 | `intent` | `authored` | `atoms/10-intent.md` | `sha256:fa5fb20c5f92ddc0…` |
| 20 | `basis` | `authored` | `atoms/20-basis.md` | `sha256:8f7d3bf0e926f6ce…` |
| 40 | `work_order` | `authored` | `atoms/40-work-order.md` | `sha256:855b71283bbb6425…` |
| 45 | `milestones` | `authored` | `atoms/45-milestones.yaml` | `sha256:8ba673adc760fe14…` |
| 60 | `assurance` | `authored` | `atoms/60-assurance.md` | `sha256:e3dad0d291d61631…` |

### Integrity

- **algorithm:** `sha256`
- **manifest digest:** `sha256:6832919295e012da25abdfac79814c4a2f857f273c576d544b890d9076bebd29`
- **composition revision digest:** `sha256:11793df141453a3087473c693f2f3e585f0f363945f4a651f9d74dbfa09dcfe8`
- **workspace basis digest:** `sha256:0009b97280cfaa4fea4261411d44f0fff7e949ab5549f9567a1171f5d9115683`
