...
if ! git diff --quiet -- docs/warrants/ docs/adr/ docs/gates/ docs/sas/ docs/authority/ openwarrant.toml \
    || ! git diff --cached --quiet -- docs/warrants/ docs/adr/ docs/gates/ docs/sas/ docs/authority/ openwarrant.toml; then
    echo "docs/warrants/, docs/adr/, docs/gates/, docs/sas/, docs/authority/ or openwarrant.toml has uncommitted changes." >&2
...
restore() {
    git checkout -- docs/warrants/ docs/adr/ docs/gates/ docs/sas/ docs/authority/ openwarrant.toml 2>/dev/null || true
